...
abstract class SiteCommentAjaxServer extends SiteXMLRPCServer
{
     ...
     *
     * @param int $comment_id the id of the comment to mark as spam
     *
     * @return bool true
     */
     ...
     *
     * @param int $comment_id the id of the comment to mark as not spam
     *
     * @return bool true
     */
     ...
     * Publishes a comment.
     *
     * @param int $comment_id the id of the comment to publish
     *
     * @return bool true
     */
     ...
     *
     * @param int $comment_id the id of the comment to unpublish
     *
     * @return bool true
     */
