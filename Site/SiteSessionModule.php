...
class SiteSessionModule extends SiteApplicationModule
{
     ...
     */
    public const REGENERATE_ID = true;
     ...
     * @see SiteAccountSessionModule::loginByAccount()
     */
    public const NO_REGENERATE_ID = false;
     ...
     *
     * @return bool true if session is active, false if the session is
     *              inactive
     */
     ...
     * activated.
     *
     * @param callable $callback   the callback to call when the session is
     *                             activated
     ...
     *
     * @return int the current session ID, or null if no active session
     */
     ...
     * @param bool   $append_sid optional. Whether or not to append the
     ...
     *
     * @return bool True if the session exists or false if it doesn't
     */
     ...
     * is regenerated.
     *
     * @param callable $callback   the callback to call when regenerating session
     *                             ID
     * @param array    $parameters optional. The paramaters to pass to the
