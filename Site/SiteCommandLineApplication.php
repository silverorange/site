...
abstract class SiteCommandLineApplication extends SiteApplication
{
     ...
     */
    public const VERBOSITY_ERRORS = 1;
     ...
     *
     * @param int $verbosity the level of verbosity to use
     */
     ...
     * @param int    $verbosity the verbosity level to display at. If this
     ...
     * @param int    $verbosity  optional. the verbosity level to display at. If
     ...
     * @param int    $error_code optional. The error code with which to
