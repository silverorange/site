...
class SiteImage extends SwatDBDataObject
{
     ...
     *
     * @return bool true if does exist, false if it doesn't
     */
     ...
     *
     * @param int $dpi The dpi of the image being processed
     */
     ...
     *
     * @param int        $width               Width of the crop bounding box
     * @param int        $height              Height of the crop bounding box
     * @param int        $offset_x            Position of the top side of the crop bounding
     *                                        box
     * @param int        $offset_y            Position of the left side of the crop bounding
     *                                        box
     * @param mixed|null $dimension_shortname
     */
     ...
     *
     * @return int threshold to use the BOX filter
     */
