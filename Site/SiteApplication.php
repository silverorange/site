...
{
    public const VAR_POST = 1;
    public const VAR_GET = 2;
    public const VAR_REQUEST = 4;
    public const VAR_COOKIE = 8;
    public const VAR_SERVER = 16;
    public const VAR_SESSION = 32;
    public const VAR_FILES = 64;
    public const VAR_ENV = 128;
     ...
     *
     * @return int the current instance id or null if no instance exists
     *
     * @see SiteMultipleInstanceModule
     */
     ...
     * @param string $feature the provided feature
     *
     * @return bool true if this applicaiton has a module that provides the
     ...
     * @param int    $types   a bitwise combination of self::VAR_*
