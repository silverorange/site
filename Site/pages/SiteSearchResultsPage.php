...
class SiteSearchResultsPage extends SiteArticlePage
{
     ...
     * @param bool   $is_array whether to expect array values in this field
     */
     ...
     *                     value
     *
     * @return bool whether the field contains a value
     */
