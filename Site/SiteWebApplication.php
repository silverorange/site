...
class SiteWebApplication extends SiteApplication
{
    ...
    public static function cleanUriGetVar($uri, $id, $value)
    {
        ...
        return preg_replace($regexp, '\1\2', $uri);
    }
    ...
    protected function parseUri()
    {
        ...
        if (class_exists(SiteImage::class)) {
     ...
     *
     * @return bool true if the current request is cacheable, otherwise
     *              false
     */
    ...
    public function getReplacementPage($source)
    {
        ...
        return $this->resolvePage($source);
    }
     ...
     *                           method.
     * @param bool   $permanent  optional. Whether or not to the relocate is
     ...
     *
     * @param int $max_length optional maximum length of the returned
     *                        remote IP
     *
