...
class SiteAdModule extends SiteApplicationModule
{
     ...
     */
    public const AD_NETWORK_GOOGLE = 1;
    public const AD_NETWORK_MICROSOFT = 3;
     ...
     * from URIs.
     *
     * @param bool $clean optional. True if inbound tracking ids should be
     ...
     *
     * @param bool $create optional. True if unknown inbound ad tracking
     ...
     *
     * @param bool $track optional. True if ad network should be tracked and
    ...
    protected function trackAdNetwork()
    {
        ...
        if ($ad_network === null) {
            $utm_medium = mb_strtolower(SiteApplication::initVar(
                'utm_medium',
                null,
                SiteApplication::VAR_GET
            ));
